...
const profiles={waka:{index:'01 / SILVER',name:'若｜WAKA',title:'DOMINANCE',images:['./assets/waka-01.png','./assets/waka-02.png','./assets/waka-poster-2.png','./assets/waka-poster.png'],details:[['HEIGHT','196 CM'],['ROLE','LEADER / VOCAL'],['STYLE','KRUMP / HIPHOP'],['COLOR','SILVER'],['BIRTHDAY','11.18'],['BLOOD TYPE','A'],['FROM','FUKUOKA, JP']],copy:'196cmの長身。KRUMPを中心とした重さ、圧、表現力、ステージを掌握する存在感が武器。重さ・圧・統率・VISION。'},ina:{index:'02 / BLUE',name:'稲｜INA',title:'GENTLEMAN',images:['./assets/ina-01.png','./assets/ina-02.png','./assets/ina-poster-2.png','./assets/ina-poster.png'],details:[['HEIGHT','188 CM'],['ROLE','ALL ROUNDER / VOCAL'],['STYLE','ALL GENRE / POP'],['COLOR','BLUE'],['BIRTHDAY','02.07'],['BLOOD TYPE','O'],['FROM','KANAGAWA, JP']],copy:'あらゆるジャンルを高いレベルで踊るオールラウンダー。高速で細かなダンスと、紳士のような丁寧でスマートな佇まい。速さ・技術・万能・VIBE。'},kuma:{index:'03 / RED',name:'隈｜KUMA',title:'IMPACT',images:['./assets/kuma-01.png','./assets/kuma-02.png','./assets/kuma-poster-2.png','./assets/kuma-poster.png'],details:[['HEIGHT','178 CM'],['ROLE','PHYSICAL / BREAK'],['STYLE','BREAK / ACROBAT / HIPHOP'],['COLOR','RED'],['BIRTHDAY','06.17'],['BLOOD TYPE','A'],['FROM','KANAGAWA, JP']],copy:'鍛えた身体と身体能力を武器にするフィジカル担当。パワームーブ、フリーズ、ジャンプ、アクロバット。強さ・肉体・爆発力・VITALITY。'}};
...
(function(){
  ...
  const skip=im=>im.closest('.ally-concept');
