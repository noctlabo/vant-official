...
'ABOUT ONLINE LIVE':'オンラインライブについて','ABOUT ONLINE LIVE →':'オンラインライブについて','STAGE LIVE':'ステージライブ — 会場公演','POSTER / DOWNLOAD':'ポスター配布 — ダウンロード','VERTICAL POSTER':'縦長ポスター','HORIZONTAL KEY VISUAL':'横長キービジュアル','DOWNLOAD (PNG) ↓':'PNG をダウンロード','VENUE':'会場','DOORS / START':'開場／開演','TICKET':'チケット','MORE FROM VΛNT FEED':'VΛNT FEED の他の投稿','WHAT IT IS':'内容','NEXT DATES':'次回日程','WATCH ON ZATAGRAM ↗':'ゼタグラムで見る','JOIN THE LIVE →':'ライブに参加する','BACK TO VΛNT FEED →':'VΛNT FEED に戻る','BACK TO LIVE →':'LIVE に戻る','SEE THE SCHEDULE →':'スケジュールを見る','HOW TO JOIN':'参加方法','DURATION':'所要時間','WHERE':'配信・会場'};
